...
namespace ExamenPractico1.Logic.Turing
{
    class Machine
    {
        ...
        private Dictionary<String, Utilities.Turing.Action> transicion;
        ...
        public Machine(String entrada, Dictionary<String, Utilities.Turing.Action> transicion)
        {
        ...
        public void run()
        {
            while (true)
            {
                ...
                Utilities.Turing.Action action;
        ...
        public void execute(Utilities.Turing.Action accion)
        {
